...
Written to: `{agent_root}/data/ocas-praxis/intake/{signal_id}.json`
...
Written to: `{agent_root}/data/ocas-forge/intake/{proposal_id}.json`
...
Written to: `{agent_root}/data/ocas-forge/intake/{decision_id}.json`
...
Every skill's `config.json` at `{agent_root}/data/{skill-name}/config.json` includes these base fields plus skill-specific configuration:
...
Written to: `{agent_root}/data/ocas-fellow/intake/{experiment_id}.json`
...
Written to: `{agent_root}/data/ocas-mentor/intake/{cycle_id}.json`
...
**Written to:** `{agent_root}/data/ocas-rally/reports/YYYY-MM-DD-daily.json`
...
**Written to:** `{agent_root}/data/ocas-taste/signals.jsonl`
...
**Used by:** Taste (writes internally)
**Written to:** `{agent_root}/data/ocas-taste/items.jsonl`
...
**Written to:** `{agent_root}/data/ocas-mentor/evaluations/{evaluation_id}.json`
